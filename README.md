...
System architecture and codebase walkthrough.
Live demonstration of document upload (PDF/TXT) and text-prompt extraction.
Demonstration of the dynamic AI triage state and PostgreSQL database persistence.
